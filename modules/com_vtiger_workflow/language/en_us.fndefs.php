...
'aggregate_time' => array(
	...
	'desc' => 'This function return aggrigate time of reltedmodule,field and conditions',
	'params' => array(
		array(
...
'stringlength' => array(
	...
	'desc' => 'This function Returns the length of the given string.',
	'params' => array(
		array(
			'name' => 'string',
			'type' => 'String',
...
'stringreplace' => array(
	...
	'params' => array(
		...
		array(
			...
			'type' => 'String',
			'optional' => false,
			'desc' => 'The string or array being searched and replaced on',
		),
	),
	'categories' => array('Strings'),
	'examples' => array(
...
'power(base,exponential)' => array(
	...
	'params' => array(
		array(
			...
			'type' => 'Integer',
			'optional' => false,
			'desc' => 'The number to exponent to',
		),
		array(
			'name' => 'exponential',
			'type' => 'Integer',
...
'num2str' => array(
	...
	'desc' => 'This function Converts number into string.',
	'params' => array(
		array(
			'name' => 'number|field',
			'type' => 'Integer',
			'optional' => false,
			'desc' => 'any valid number or number type field name',
		),
		array(
			'name' => 'language',
			'type' => 'String',
			'optional' => false,
			'desc' => 'language you need to convert the number',
		),
	),
	'categories' => array('Strings'),
	'examples' => array(
...
'number_format' => array(
	...
	'params' => array(
		...
		array(
			...
			'type' => 'String',
			'optional' => true,
			'desc' => 'Specifies what string to use for decimal point',
		),
		array(
...
'translate' => array(
	...
	'desc' => 'This function translate a given string.',
	'params' => array(
		array(
			'name' => 'string|field',
			'type' => 'String',
			'optional' => false,
			'desc' => 'any string or string type field name to translate',
		),
	),
	'categories' => array('Strings'),
	'examples' => array(
...
'modulo' => array(
	...
	'desc' => 'This function eturns the remainder of numericfield.',
	'params' => array(
		array(
			'name' => 'numericfield',
			'type' => 'Integer',
			'optional' => false,
			'desc' => 'value or field for module ',
		),
	),
	'categories' => array('Math'),
	'examples' => array(
...
'hash' => array(
	...
	'desc' => 'This function Generate a hash value (message digest).',
	'params' => array(
		array(
			'name' => 'field',
			'type' => 'String',
...
'globalvariable' => array(
	...
	'params' => array(
		array(
			...
			'type' => 'String',
			'optional' => false,
			'desc' => 'any global variable or globalvariable type field name',
		),
	),
...
'aggregation' => array(
	...
	'params' => array(
		...
		array(
			...
			'type' => 'String',
			'optional' => true,
			'desc' => 'condiotion used for that aggregation',
		),
	),
...
'aggregation_fields_operation' => array(
	...
	'desc' => 'This is a function which aggrigate operation with related module,related field to operation and condition.',
	'params' => array(
		array(
			'name' => 'operation',
			'type' => 'String',
		...
		array(
			...
			'type' => 'String',
			'optional' => false,
			'desc' => 'any field related to aggrigate with operation',
		),
		array(
			'name' => 'conditions',
			'type' => 'String',
...
'getCurrentUserID' => array(
	...
	'desc' => 'This function return current user ID.',
	'params' => array(
	),
...
'getCurrentUserName' => array(
	...
	'desc' => 'This function return current user name in full.',
	'params' => array(
	),
	'categories' => array('user'),
	'examples' => array(
...
'getCurrentUserField' => array(
	...
	'desc' => 'This function return current user of a fieldname eg current user email.',
	'params' => array(
		array(
			'name' => 'fieldname',
			'type' => 'String',
...
'getimageurl' => array(
	...
	'desc' => 'This function return image url.',
	'params' => array(
		array(
			'name' => 'field',
			'type' => 'String',
...
'getLatitude' => array(
	...
	'desc' => 'This function return latitude of a gven address.',
	'params' => array(
		array(
			'name' => 'address',
			'type' => 'String',
...
'getLongitude' => array(
	...
	'desc' => 'This function longitude of a given address.',
	'params' => array(
		array(
			'name' => 'address',
			'type' => 'String',
...
'getGEODistance' => array(
	...
	'desc' => 'This function return distance from one address to another.',
	'params' => array(
		array(
			'name' => 'address_from',
			'type' => 'String',
...
'getGEODistanceFromCompanyAddress' => array(
	...
	'desc' => 'This function return geo distance from company address.',
	'params' => array(
		array(
			'name' => 'address',
			'type' => 'String',
...
'getGEODistanceFromUserAddress' => array(
	...
	'desc' => 'This function return geo distance from user adress.',
	'params' => array(
		array(
			'name' => 'address',
			'type' => 'String',
...
'getGEODistanceFromAssignUser2AccountShipping' => array(
	...
	'desc' => 'This function Calculate distance from AssignUser to AccountShipping address.',
	'params' => array(
		array(
			'name' => 'account',
			'type' => 'String',
...
'getGEODistanceFromAssignUser2ContactShipping' => array(
	...
	'desc' => 'This function Calculate distance from Assignuser to ContactShipping address.',
	'params' => array(
		array(
			'name' => 'contact',
			'type' => 'String',
...
'getGEODistanceFromCoordinates' => array(
	...
	'desc' => 'This function Calculate distance from coordinates such as latitude amd longtudes.',
	'params' => array(
		array(
			'name' => '{lat1}',
			'type' => 'String',
...
'getFromContext' => array(
	...
	'desc' => 'This function to get context from a variablename.',
	'params' => array(
		array(
			'name' => 'variablename',
			'type' => 'String',
...
'setToContext' => array(
	...
	'desc' => 'This function to set context to a variablename.',
	'params' => array(
		array(
			'name' => 'variablename',
			'type' => 'String',
...
'implode' => array(
	...
	'desc' => 'This function return a string from the elements of an array.',
	'params' => array(
		array(
			'name' => 'delimiter',
			'type' => 'String',
...
'sendMessage' => array(
	...
	'desc' => 'This function return context from a variablename.',
	'params' => array(
		array(
			'name' => 'message',
			'type' => 'String',
...
'readMessage' => array(
	...
	'desc' => 'This function allow to read message in a channel.',
	'params' => array(
		array(
			'name' => 'channel',
			'type' => 'String',
...
'getSetting' => array(
	...
	'desc' => 'This function allow to get setting from a setting key with it default.',
	'params' => array(
		array(
			'name' => 'setting_key',
			'type' => 'String',
...
'setSetting' => array(
	...
	'desc' => 'This function allow to set setting to a setting key with it default.',
	'params' => array(
		array(
			'name' => 'setting_key',
			'type' => 'String',
...
'isNumeric' => array(
	...
	'desc' => 'This function check if a fieldname is numeric.',
	'params' => array(
		array(
			'name' => 'fieldname',
			'type' => 'String',
			'optional' => false,
			'desc' => 'fieldname to check if its numeric',
		),
	),
...
'isString' => array(
	...
	'desc' => 'This function check if fieldname is string.',
	'params' => array(
		array(
			'name' => 'fieldname',
			'type' => 'String',
...
'regex' => array(
	...
	'desc' => 'This function return regex of a given patten and subject.',
	'params' => array(
		array(
			'name' => 'pattern',
			'type' => 'String',
...
'allrelatedare' => array(
	...
	'desc' => 'This function check all related  record if exist to  related  module.',
	'params' => array(
		array(
			'name' => 'relatedmodule',
			'type' => 'String',
...
'min' => array(
	'name' => 'min(fieldname)',
	'desc' => 'This function return minimum of a fielname.',
	'params' => array(
		array(
			'name' => 'fieldname',
			'type' => 'String',
...
'max' => array(
	'name' => 'max(fieldname)',
	'desc' => 'This function return maximum of a fielname.',
	'params' => array(
		array(
			'name' => 'fieldname',
			'type' => 'String',
